...
app = FastAPI(
    ...
    description=(
        "Backend API for Expense Planner with FastAPI, MongoDB and bearer token sessions.\n\n"
        "Main flow:\n"
        "1. Login with username and password.\n"
        "2. If user status is `New`, force initial password change and allow optional username update.\n"
